...
import AIReviewPanel from './ai-review';
...
export default function Page(){
 ...
 return <div className="app-frame">
  ...
  <main>
   ...
   <footer><span>IMPERIUM <span className="footer-divider">/</span> COUNCIL & COMMAND</span><button onClick={()=>setInfo('Foundation build: secure campaign drafts and optional paid AI draft review. Simulation, AI council, maps and Begin Reign are not available yet. AI review is limited to the approved testing account and lifetime budget.')}><CircleHelp size={14}/> About this build</button></footer>
